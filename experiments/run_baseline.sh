#!/bin/bash
# =============================================================================
# G1: Baseline — 复现原文 (δ=0.4, max_new_skills=3, 150 steps)
#
# 用法:
#   export MODEL_PATH=/data/hwt/hf_data/Alfworld-7B-SFT
#   export ALFWORLD_DATA=/data/hwt/alfworld_data
#   export SKILL_API_KEY="your-key"              # 如用 openai 兼容 API
#   export SKILL_BASE_URL="https://xxx/v1"       # 如用 openai 兼容 API
#   export SKILL_MODEL="deepseek-chat"            # 如用 openai 兼容 API
#   bash experiments/run_baseline.sh [vllm|sglang] [--extra-flags]
# =============================================================================
set -x
...
# ---------- 选择 API 后端 ----------
# 默认 azure；如设置了 SKILL_API_KEY 则自动切换为 openai 兼容 API
