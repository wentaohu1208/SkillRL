#!/bin/bash
# =============================================================================
# G1: Baseline 双卡版 — 复现原文 (δ=0.4, max_new_skills=3, 150 steps)
#
# 用法:
#   CUDA_VISIBLE_DEVICES=2,3 bash experiments/run_baseline_2gpu.sh
# =============================================================================
set -x
...
# ---------- Wandb ----------
export WANDB_NAME="g1_baseline_2gpu"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='g1_baseline_2gpu' \
